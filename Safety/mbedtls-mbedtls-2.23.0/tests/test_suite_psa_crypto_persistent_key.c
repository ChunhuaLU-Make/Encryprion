 ...
 *      Test suite file     : suites/test_suite_psa_crypto_persistent_key.function
 *      Test suite data     : suites/test_suite_psa_crypto_persistent_key.data
 *
 *
...
#line 2 "suites/test_suite_psa_crypto_persistent_key.function"
...
#line 42 "suites/test_suite_psa_crypto_persistent_key.function"
...
void test_format_storage_data_check_wrapper( void ** params )
{
    ...
    test_format_storage_data_check( &data0, &data2, *( (int *) params[4] ), *( (int *) params[5] ), *( (int *) params[6] ), *( (int *) params[7] ), *( (int *) params[8] ) );
}
#line 72 "suites/test_suite_psa_crypto_persistent_key.function"
...
void test_parse_storage_data_check_wrapper( void ** params )
{
    ...
    test_parse_storage_data_check( &data0, &data2, *( (int *) params[4] ), *( (int *) params[5] ), *( (int *) params[6] ), *( (int *) params[7] ), *( (int *) params[8] ), *( (int *) params[9] ) );
}
#line 113 "suites/test_suite_psa_crypto_persistent_key.function"
...
#line 142 "suites/test_suite_psa_crypto_persistent_key.function"
void test_persistent_key_destroy( int key_id_arg, int restart,
...
#line 196 "suites/test_suite_psa_crypto_persistent_key.function"
...
void test_persistent_key_import_wrapper( void ** params )
{
    ...
    test_persistent_key_import( *( (int *) params[0] ), *( (int *) params[1] ), &data2, *( (int *) params[4] ), *( (int *) params[5] ) );
}
#line 244 "suites/test_suite_psa_crypto_persistent_key.function"
...
void test_import_export_persistent_key_wrapper( void ** params )
{
    ...
    test_import_export_persistent_key( &data0, *( (int *) params[2] ), *( (int *) params[3] ), *( (int *) params[4] ), *( (int *) params[5] ) );
}
